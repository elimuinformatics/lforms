...
module.exports = function (config) {
  config.set({
    ...
    files: [
      ...
      {
        pattern: "dist/@elimuinformatics/lforms/webcomponent/*.js.map",
        included: false,
        served: true,
      },
      "dist/@elimuinformatics/lforms/webcomponent/assets/lib/zone.min.js",
      "dist/@elimuinformatics/lforms/webcomponent/runtime.js",
      "dist/@elimuinformatics/lforms/webcomponent/polyfills.js",
      "dist/@elimuinformatics/lforms/webcomponent/main.js",
    ...
    customLaunchers: {
      ChromeHeadless_without_password_security: {
        base: "ChromeHeadless",
        flags: ["--password-store=basic", "--timezone=America/New_York"],
      },
